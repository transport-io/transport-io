...
- 27b5e82: The status line shows `lastError`: its code always, beside the status, and what was thrown
...
- 7682edc: The open panel pads the page by its own height, and puts the padding back when it closes.
